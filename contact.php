                    ...
                    <div class="htc__contact__wrap clearfix">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="ht__address">
                                ...
                                <div class="ht__address__info">
                                    <p><a href="#">01725002750</a></p>
                                    <p><a href="#">9888002750</a></p>
                                </div>
                            </div>
                        </div>
                        <!-- End Single Contact -->
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12 xsmt--40">
                            <div class="ht__address">
                                <h2>Our Location</h2>
                                <div class="ht__address__info">
                                    <p>Plot no.500,Phase-9,Industrial Area,
                                        S.A.S.Nagar(MOHALI)-160062 India.</p>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-lg-3 col-sm-6 col-xs-12 smt--40 xsmt--40">
                            <div class="footer">
                                 <h2 class="ft__title">Quick Info </h2>
                                <ul class="ht__link">
                                    <li><a href="#">GST : 03ADLPM4636Q2Z0 </a></li>
                                    <li><a href="#">FSSAI No : 10019063001497 </a></li>
                                    <li><a href="#"><strong>Account Info</strong></a></li>
                                    <li><a href="#">ICICI BANK, A/C NO :  342105500253 </a></li>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="copyright__inner">
                                <p>Copyright<i class="icofont icofont-copyright"></i>2019 PHYTOLOGIX LIFE SCIENCES. ALL Right Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
